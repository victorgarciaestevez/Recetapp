...
public class CategoriasService implements ICategoriasService {
	...
	public void crearCategoria(CategoriaItem categoria) throws ServiceException {
		try {
			...
			throw new ServiceException("Error al crear categoria"
					+ categoria.getDescripcion() + "': " + e.getMessage());

		} catch (NullPointerException e) {
			throw new ServiceException(
					"Error al crear categoria, la categoria no puede ser nula "
							+ e.getMessage());
	...
	@Override
	public List<CategoriaItem> listaCategoria() throws ServiceException {
	...
	public CategoriaItem obtenerCategoria(Long id) throws ServiceException {
		...
		try{
			if(id==null){
				throw new ServiceException("Error al recuperar la categoria :Debe especificar el id");
			}
			Connection conn = DataBase.getConnection();
			PreparedStatement statement = conn
		...
		ResultSet rs=	statement.executeQuery();
			...
			throw new ServiceException("Error al recuperar la categoria con ID "+ id);
		}
		return categoria;
	}
